  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl p-6">
        <Link to={`Displaystudent/${details.Technology}`} className="flex flex-col items-center  p-6  bg-gray-800 hover:bg-gray-900 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
        ...
        <Link to={`Trainerpage/${details.Technology}`} className="flex flex-col items-center bg-gray-800 hover:bg-gray-900 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out" onClick={startAttendance}>
