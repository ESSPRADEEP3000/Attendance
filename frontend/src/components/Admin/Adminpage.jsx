...
const Admin = () => {
  ...
  return (
    <div className="mt-5 container mx-auto  px-4 w-[80vw]  ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8 ">
        {/* Student List Card */}
        <Link to={`Displayall`} className="block p-6 bg-gray-800 text-white rounded-lg shadow-md hover:bg-gray-900 transition duration-200">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-white">View all students</p>
            </div>
          </div>
        </Link>

        {/* Add Trainer Card */}
        <Link to={`AddTrainer`} className="block p-6 bg-gray-800 text-white rounded-lg shadow-md hover:bg-gray-900 transition duration-200">
          <div className="flex items-center">
            <img src="https://attendance-9sen.onrender.com/images/studprofile.png" alt="Add Trainer" className="w-16 h-16 rounded-full mr-4" />
            <div>
              <h2 className="text-2xl font-semibold">Add Trainer</h2>
              <p className="text-white">Add a new trainer</p>
            </div>
          </div>
        </Link>

        {/* Trainer List Card */}
        <Link to={`Trainerlist`} className="block p-6 bg-gray-800 text-white rounded-lg shadow-md hover:bg-gray-900 transition duration-200">
          <div className="flex items-center">
            <img src="https://attendance-9sen.onrender.com/images/studprofile.png" alt="Trainer List" className="w-16 h-16 rounded-full mr-4" />
            <div>
              <h2 className="text-2xl font-semibold">Trainer List</h2>
              <p className="text-white">View all trainers</p>
            </div>
          </div>
        </Link>
